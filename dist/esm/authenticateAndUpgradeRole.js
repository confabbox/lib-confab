import { CONNECTION_DISCONNECTED, CONNECTION_ESTABLISHED, CONNECTION_FAILED } from './ConfabConnectionEvents';
...
roomPassword }) {
    ...
    const process = new Promise((resolve, reject) => {
        ...
        xmpp.addListener(CONNECTION_FAILED, (connectionError, message, credentials) => {
            reject({
                connectionError,
                credentials,
                message
