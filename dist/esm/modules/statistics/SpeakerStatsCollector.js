...
export default class SpeakerStatsCollector {
    ...
    constructor(conference) {
        ...
        conference.addEventListener(ConfabConferenceEvents.DOMINANT_SPEAKER_CHANGED, this._onDominantSpeaker.bind(this));
        conference.addEventListener(ConfabConferenceEvents.USER_JOINED, this._onUserJoin.bind(this));
        conference.addEventListener(ConfabConferenceEvents.USER_LEFT, this._onUserLeave.bind(this));
        conference.addEventListener(ConfabConferenceEvents.DISPLAY_NAME_CHANGED, this._onDisplayNameChange.bind(this));
        conference.addEventListener(ConfabConferenceEvents.FACE_LANDMARK_ADDED, this._onFaceLandmarkAdd.bind(this));
        if (conference.xmpp) {
        ...
        for (const userId in newStats) { // eslint-disable-line guard-for-in
            ...
            if (!newParticipant || !newParticipant.isHidden()) {
                if (this.stats.users[userId]) {
                    ...
                    speakerStatsToUpdate = new SpeakerStats(userId, newStats[userId].displayName);
