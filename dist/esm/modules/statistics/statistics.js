...
function loadCallStatsAPI(options) {
    if (!isCallstatsLoaded) {
        ScriptUtil.loadScript(options.customScriptUrl || CALLSTATS_SCRIPT_URL, 
        /* async */ true, 
        /* prepend */ true, 
...
Statistics.prototype.attachLongTasksStats = function (conference) {
    ...
    conference.on(ConfabConferenceEvents.CONFERENCE_JOINED, () => this.performanceObserverStats.startObserver());
    conference.on(ConfabConferenceEvents.CONFERENCE_LEFT, () => this.performanceObserverStats.stopObserver());
};
/**
...
Statistics.prototype.startCallStats = function (tpc, remoteUserID) {
    ...
    const newInstance = new CallStats(tpc, {
...
Statistics.sendGetUserMediaFailed = function (e) {
    const error = e instanceof ConfabTrackError
