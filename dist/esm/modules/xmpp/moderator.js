...
Moderator.prototype.createConferenceIq = function () {
    ...
    // signal if false.
    const rtcstatsEnabled = (_c = (_b = (_a = this.options.conference) === null || _a === void 0 ? void 0 : _a.analytics) === null || _b === void 0 ? void 0 : _b.rtcstatsEnabled) !== null && _c !== void 0 ? _c : false;
    if (!rtcstatsEnabled) {
        elem.c('property', {
...
Moderator.prototype.parseConfigOptions = function (resultIq) {
    ...
    const authenticationEnabled = $(resultIq).find('>conference>property'
        + '[name=\'authentication\'][value=\'true\']').length > 0;
    logger.info(`Authentication enabled: ${authenticationEnabled}`);
    this.externalAuthEnabled = $(resultIq).find('>conference>property'
    ...
    if ($(resultIq).find('>conference>property'
...
Moderator.prototype.allocateConferenceFocus = function () {
    return new Promise(resolve => {
        ...
        this.connection.sendIQ(this.createConferenceIq(), result => this._allocateConferenceFocusSuccess(result, resolve), error => this._allocateConferenceFocusError(error, resolve));
