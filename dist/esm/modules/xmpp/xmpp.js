...
export default class XMPP extends Listenable {
    ...
    constructor(options, token) {
        ...
        this.connection.on(XmppConnection.Events.CONN_SHARD_CHANGED, () => {
            ...
            this.eventEmitter.emit(ConfabConnectionEvents.CONNECTION_FAILED, ConfabConnectionErrors.OTHER_ERROR, undefined, undefined, details);
        });
    ...
    connectionHandler(credentials = {}, status, msg) {
        ...
        if (status === Strophe.Status.CONNECTED || status === Strophe.Status.ATTACHED) {
            ...
            if (this.connection && this.connection.connected
                ...
                this.eventEmitter.emit(ConfabConnectionEvents.CONNECTION_ESTABLISHED, Strophe.getResourceFromJid(this.connection.jid));
            }
        }
            ...
            if (msg === 'giving-up') {
                this.eventEmitter.emit(ConfabConnectionEvents.CONNECTION_FAILED, ConfabConnectionErrors.OTHER_ERROR, msg);
            }
        }
            ...
            if (this.anonymousConnectionFailed) {
                ...
                this.eventEmitter.emit(ConfabConnectionEvents.CONNECTION_FAILED, ConfabConnectionErrors.PASSWORD_REQUIRED);
            }
            else if (this.connectionFailed) {
                this.eventEmitter.emit(ConfabConnectionEvents.CONNECTION_FAILED, ConfabConnectionErrors.OTHER_ERROR, errMsg, undefined, /* credentials */ this._getConnectionFailedReasonDetails());
            }
            else if (wasIntentionalDisconnect) {
                this.eventEmitter.emit(ConfabConnectionEvents.CONNECTION_DISCONNECTED, errMsg);
            }
            else {
                ...
                if (lastErrorStatus >= 500 && lastErrorStatus < 600) {
                    this.eventEmitter.emit(ConfabConnectionEvents.CONNECTION_FAILED, ConfabConnectionErrors.SERVER_ERROR, errMsg || 'server-error', 
                    /* credentials */ undefined, this._getConnectionFailedReasonDetails());
                }
                else {
                    this.eventEmitter.emit(ConfabConnectionEvents.CONNECTION_FAILED, ConfabConnectionErrors.CONNECTION_DROPPED_ERROR, errMsg || 'connection-dropped-error', 
                    /* credentials */ undefined, this._getConnectionFailedReasonDetails());
                }
            }
        }
            ...
            this.eventEmitter.emit(ConfabConnectionEvents.CONNECTION_FAILED, ConfabConnectionErrors.PASSWORD_REQUIRED, msg || this._parseConnectionFailedMessage(lastFailedRawMessage), credentials);
        }
    }
    /**
