...
export default class JingleConnectionPlugin extends ConnectionPlugin {
        ...
        switch (action) {
            case 'session-initiate': {
                ...
                if (startMuted === null || startMuted === void 0 ? void 0 : startMuted.length) {
                    ...
                    this.eventEmitter.emit(XMPPEvents.START_MUTED_FROM_FOCUS, audioMuted === 'true', videoMuted === 'true');
                }
            ...
            case 'transport-replace': {
                ...
                const dtlsFingerprint = (_a = $(transport).find('>fingerprint')) === null || _a === void 0 ? void 0 : _a.text();
                ...
                Statistics.sendAnalytics(createJingleEvent(ACTION_JINGLE_TR_RECEIVED, {
                    p2p: isP2P,
                    value: now
                }));
                sess.replaceTransport($(iq).find('>jingle'), () => {
                    ...
                    Statistics.sendAnalytics(createJingleEvent(ACTION_JINGLE_TR_SUCCESS, {
                        p2p: isP2P,
                        value: successTime
                    }));
                }, error => {
    ...
    newP2PJingleSession(me, peer) {
        const sess = new JingleSessionPC(RandomUtil.randomHexString(12), me, peer, this.connection, this.mediaConstraints, this.p2pIceConfig, 
        /* P2P */ true, 
        /* initiator */ true);
        this.sessions[sess.sid] = sess;
        return sess;
