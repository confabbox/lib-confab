...
export default class JingleSessionPC extends JingleSession {
    ...
    constructor(sid, localJid, remoteJid, connection, mediaConstraints, pcConfig, isP2P, isInitiator) {
        ...
        this._xmppListeners = [];
        this._xmppListeners.push(connection.addEventListener(XmppConnection.Events.CONN_STATUS_CHANGED, this.onXmppStatusChanged.bind(this)));
    ...
    doInitialize(options) {
            ...
            = browser.supportsUnifiedPlan()
                && (browser.isFirefox()
                    ...
                    || (browser.isChromiumBased()
                        ...
                        && this.isP2P
                        ? (_b = (_a = options.p2p) === null || _a === void 0 ? void 0 : _a.enableUnifiedOnChrome) !== null && _b !== void 0 ? _b : true
                        : (_c = options.enableUnifiedOnChrome) !== null && _c !== void 0 ? _c : true));
        if (this.isP2P) {
            ...
            pcOptions.capScreenshareBitrate = pcOptions.disableSimulcast
                || !(typeof ((_d = options.desktopSharingFrameRate) === null || _d === void 0 ? void 0 : _d.max) === 'number'
                    && ((_e = options.desktopSharingFrameRate) === null || _e === void 0 ? void 0 : _e.max) > SS_DEFAULT_FRAME_RATE);
        ...
        this.peerconnection.onicecandidate = ev => {
            ...
            if (candidate) {
                ...
                // End of gathering
                Statistics.sendAnalytics(ICE_DURATION, {
                    phase: 'gathering',
        ...
        this.peerconnection.oniceconnectionstatechange = () => {
            ...
            Statistics.sendAnalytics(ICE_STATE_CHANGED, {
                p2p: this.isP2P,
    ...
    replaceTransport(jingleOfferElem, success, failure) {
        ...
        this.setOfferAnswerCycle(jingleOfferElem, () => {
            ...
            this.setOfferAnswerCycle(originalOffer, () => {
                ...
                this.room.eventEmitter.emit(XMPPEvents.ICE_RESTART_SUCCESS, this, originalOffer);
            }, failure);
        }, failure);
    }
    /**
            ...
            if (this.usesUnifiedPlan) {
                ...
                lines.forEach(line => {
                    ...
                    if (mid > -1) {
                        ...
                        if (this.isP2P) {
                            const mediaType = (_a = SDPUtil.parseMLine(remoteSdp.media[mid].split('\r\n')[0])) === null || _a === void 0 ? void 0 : _a.media;
    ...
    _processRemoteAddSource(addSsrcInfo) {
        ...
        addSsrcInfo.forEach((lines, idx) => {
            ...
            if (this.isP2P && this.usesUnifiedPlan) {
                const mediaType = (_a = SDPUtil.parseMLine(remoteSdp.media[idx].split('\r\n')[0])) === null || _a === void 0 ? void 0 : _a.media;
    ...
    _parseSsrcInfoFromSourceRemove(sourceRemoveElem, currentRemoteSdp) {
        ...
        $(sourceRemoveElem).each((i1, content) => {
            ...
            currentRemoteSdp.media.forEach((media, i2) => {
                ...
                ssrcs.forEach(ssrc => {
                    const ssrcLines = SDPUtil.findLines(media, `a=ssrc:${ssrc}`);
                    if (ssrcLines.length) {
    ...
    _verifyNoSSRCChanged(operationName, oldSDP) {
        const currentLocalSDP = new SDP(this.peerconnection.localDescription.sdp);
    ...
    _addRemoveTrackAsMuteUnmute(isMute, track) {
        ...
        const workFunction = finishedCallback => {
            ...
            if (!tpc) {
                finishedCallback(`Error:  tried ${operationName} track with no active peer`
                    + 'connection');
                return;
            }
            const oldLocalSDP = tpc.localDescription.sdp;
            const operationPromise = isMute
    ...
    setMediaTransferActive(audioActive, videoActive) {
        if (!this.peerconnection) {
            return Promise.reject('Can not modify transfer active state,'
        ...
        const workFunction = finishedCallback => {
            ...
            const pcVideoActiveChanged = this.peerconnection.setVideoTransferActive(this._localVideoActive && this._remoteVideoActive);
            // Will do the sRD/sLD cycle to update SDPs and adjust the media
            // direction
            if (isSessionActive
                && (audioActiveChanged || pcVideoActiveChanged)) {
                this._renegotiate()
                    .then(finishedCallback, finishedCallback /* will be called with an error */);
            }
            else {
                finishedCallback();
            }
