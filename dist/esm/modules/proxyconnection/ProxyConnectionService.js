...
export default class ProxyConnectionService {
     ...
     */
    constructor(options = {}) {
        const { confabConnection } = options, otherOptions = __rest(options, ["confabConnection"]);
        /**
         * Holds a reference to the collection of all callbacks.
         *
         * @type {Object}
         */
        this._options = Object.assign({ pcConfig: confabConnection && confabConnection.xmpp.connection.jingle.p2pIceConfig }, otherOptions);
        /**
