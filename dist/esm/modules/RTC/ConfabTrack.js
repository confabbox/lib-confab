...
export default class ConfabTrack extends EventEmitter {
    ...
    setAudioLevel(audioLevel, tpc) {
        ...
        if (this.audioLevel !== newAudioLevel) {
            ...
            this.emit(ConfabTrackEvents.TRACK_AUDIO_LEVEL_CHANGED, newAudioLevel, tpc);
            ...
            this.emit(ConfabTrackEvents.NO_AUDIO_INPUT, newAudioLevel);
        }
    }
    /**
    ...
    setAudioOutput(audioOutputDeviceId) {
        ...
        return (Promise.all(this.containers.map(element => element.setSinkId(audioOutputDeviceId)
            ...
            .then(() => {
            this.emit(ConfabTrackEvents.TRACK_AUDIO_OUTPUT_CHANGED, audioOutputDeviceId);
        }));
    }
}
//# sourceMappingURL=ConfabTrack.js.map