    ...
    init(options = {}) {
        ...
        if (this.isDeviceListAvailable()) {
            this.enumerateDevices(ds => {
                ...
                sendDeviceListToAnalytics(availableDevices);
                eventEmitter.emit(RTCEvents.DEVICE_LIST_AVAILABLE, availableDevices);
    ...
    obtainAudioAndVideoPermissions(options) {
        ...
        const maybeRequestDesktopDevice = function () {
            ...
            if (desktopSharingSourceDevice) {
                ...
                if (!matchingDevice) {
                    return Promise.reject(new ConfabTrackError({ name: 'ConstraintNotSatisfiedError' }, {}, [desktopSharingSourceDevice]));
                }
    ...
    return function (element, stream) {
        ...
        if (stream
            ...
            element.setSinkId(rtcUtils.getAudioOutputDevice())
                .catch(function (ex) {
                const err = new ConfabTrackError(ex, null, ['audiooutput']);
