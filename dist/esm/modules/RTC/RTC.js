...
export default class RTC extends Listenable {
    ...
    _onLastNChanged(lastNEndpoints = []) {
        ...
        this.conference.eventEmitter.emit(ConfabConferenceEvents.LAST_N_ENDPOINTS_CHANGED, leavingLastNEndpoints, enteringLastNEndpoints);
    }
    /**
    ...
    _onForwardedSourcesChanged(forwardedSources = []) {
        ...
        this.conference.eventEmitter.emit(ConfabConferenceEvents.FORWARDED_SOURCES_CHANGED, leavingForwardedSources, enteringForwardedSources, Date.now());
    }
    /**
