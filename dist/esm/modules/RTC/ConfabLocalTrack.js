...
import { TRACK_IS_DISPOSED, TRACK_NO_STREAM_FOUND } from '../../ConfabTrackErrors';
import { LOCAL_TRACK_STOPPED, NO_DATA_FROM_SOURCE, TRACK_MUTE_CHANGED } from '../../ConfabTrackEvents';
...
export default class ConfabLocalTrack extends ConfabTrack {
    ...
    _initNoDataFromSourceHandlers() {
        ...
        this._setHandler('track_unmute', () => {
            this._fireNoDataFromSourceEvent();
            Statistics.sendAnalyticsAndLog(TRACK_UNMUTED, {
...
//# sourceMappingURL=ConfabLocalTrack.js.map