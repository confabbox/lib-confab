...
export class CodecSelection {
    ...
    constructor(conference, options) {
        ...
        this.conference.on(ConfabConferenceEvents.USER_JOINED, () => this._selectPreferredCodec());
        this.conference.on(ConfabConferenceEvents.USER_LEFT, () => this._selectPreferredCodec());
        this.conference.on(ConfabConferenceEvents._MEDIA_SESSION_STARTED, session => this._onMediaSessionStarted(session));
    }
    /**
