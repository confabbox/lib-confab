...
export default class ParticipantConnectionStatusHandler {
    ...
    init() {
        ...
        if (browser.supportsVideoMuteOnConnInterrupted()) {
            ...
            this.conference.on(ConfabConferenceEvents.TRACK_ADDED, this._onRemoteTrackAdded);
            this._onRemoteTrackRemoved = this.onRemoteTrackRemoved.bind(this);
            this.conference.on(ConfabConferenceEvents.TRACK_REMOVED, this._onRemoteTrackRemoved);
        ...
        this.conference.on(ConfabConferenceEvents.LAST_N_ENDPOINTS_CHANGED, this._onLastNChanged);
    ...
    dispose() {
        ...
        if (browser.supportsVideoMuteOnConnInterrupted()) {
            ...
            this.conference.off(ConfabConferenceEvents.TRACK_ADDED, this._onRemoteTrackAdded);
            this.conference.off(ConfabConferenceEvents.TRACK_REMOVED, this._onRemoteTrackRemoved);
        }
        this.conference.off(ConfabConferenceEvents.LAST_N_ENDPOINTS_CHANGED, this._onLastNChanged);
    ...
    _changeConnectionStatus(participant, newStatus) {
        if (participant.getConnectionStatus() !== newStatus) {
            ...
            this.conference.eventEmitter.emit(ConfabConferenceEvents.PARTICIPANT_CONN_STATUS_CHANGED, endpointId, newStatus);
        }
    }
    /**
    ...
    onRemoteTrackAdded(remoteTrack) {
        if (!remoteTrack.isLocal()
            ...
            remoteTrack.on(ConfabTrackEvents.TRACK_MUTE_CHANGED, this._onSignallingMuteChanged);
            remoteTrack.on(ConfabTrackEvents.TRACK_VIDEOTYPE_CHANGED, videoType => this._onTrackVideoTypeChanged(remoteTrack, videoType));
        }
    }
    /**
    ...
    onRemoteTrackRemoved(remoteTrack) {
        if (!remoteTrack.isLocal()
            ...
            remoteTrack.off(ConfabTrackEvents.TRACK_MUTE_CHANGED, this._onSignallingMuteChanged);
    ...
    figureOutConnectionStatus(id) {
        ...
        const newState = inP2PMode
            ? ParticipantConnectionStatusHandler._getNewStateForP2PMode(isVideoMuted, isVideoTrackFrozen)
            : ParticipantConnectionStatusHandler._getNewStateForJvbMode(isConnActiveByJvb, isInLastN, isRestoringTimedOut, isVideoMuted, isVideoTrackFrozen);
        ...
        if (!('p2p' in oldConnectionStatus)
            ...
            this.connectionStatusMap[id] = Object.assign(Object.assign({}, oldConnectionStatus), { connectionStatus: newState, p2p: inP2PMode, startedMs: nowMs });
    ...
    maybeSendParticipantConnectionStatusEvent(id, nowMs) {
        ...
        if (participantConnectionStatus
            ...
            Statistics.sendAnalytics(createParticipantConnectionStatusEvent(participantConnectionStatus));
        }
    }
    /**
