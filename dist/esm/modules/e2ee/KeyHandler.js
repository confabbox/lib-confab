...
export class KeyHandler extends Listenable {
    ...
    constructor(conference, options = {}) {
        ...
        //
        this.conference.on(ConfabConferenceEvents._MEDIA_SESSION_STARTED, this._onMediaSessionStarted.bind(this));
        this.conference.on(ConfabConferenceEvents.TRACK_ADDED, track => track.isLocal() && this._onLocalTrackAdded(track));
        this.conference.rtc.on(RTCEvents.REMOTE_TRACK_ADDED, (track, tpc) => this._setupReceiverE2EEForTrack(tpc, track));
        this.conference.on(ConfabConferenceEvents.TRACK_MUTE_CHANGED, this._trackMuteChanged.bind(this));
    }
    /**
