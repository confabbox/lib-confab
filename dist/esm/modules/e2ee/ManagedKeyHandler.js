...
export class ManagedKeyHandler extends KeyHandler {
    ...
    constructor(conference) {
        ...
        this.conference.on(ConfabConferenceEvents.PARTICIPANT_PROPERTY_CHANGED, this._onParticipantPropertyChanged.bind(this));
        this.conference.on(ConfabConferenceEvents.USER_JOINED, this._onParticipantJoined.bind(this));
        this.conference.on(ConfabConferenceEvents.USER_LEFT, this._onParticipantLeft.bind(this));
        this.conference.on(ConfabConferenceEvents.CONFERENCE_JOINED, () => {
