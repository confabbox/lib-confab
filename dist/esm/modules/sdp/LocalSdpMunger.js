...
export default class LocalSdpMunger {
    ...
    _addMutedLocalVideoTracksToSDP(transformer) {
        ...
        const videoMLine = (_a = transformer.selectMedia(MediaType.VIDEO)) === null || _a === void 0 ? void 0 : _a[0];
        if (!videoMLine) {
    ...
    transformStreamIdentifiers(sessionDesc) {
        ...
        const audioMLine = (_a = transformer.selectMedia(MediaType.AUDIO)) === null || _a === void 0 ? void 0 : _a[0];
        if (audioMLine) {
