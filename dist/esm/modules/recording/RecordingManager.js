...
class RecordingManager {
    ...
    startRecording(options) {
        const session = new JibriSession(Object.assign(Object.assign({}, options), { connection: this._chatRoom.connection }));
    ...
    _handleJibriPresence(presence) {
        const { liveStreamViewURL, mode, sessionID } = recordingXMLUtils.getHiddenDomainUpdate(presence);
        if (!sessionID) {
