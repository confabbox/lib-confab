...
function _mergeNamespaceAndModule(module) {
    return (typeof window.ConfabMeetJS === 'object'
    ...
    */
    ...
    createLocalTracks(options = {}, oldfirePermissionPromptIsShownEvent) {
        ...
        if (firePermissionPrompt && !RTC.arePermissionsGrantedForAvailableDevices()) {
            ConfabMediaDevices.emitEvent(ConfabMediaDevicesEvents.PERMISSION_PROMPT_IS_SHOWN, browser.getName());
        }
...
//# sourceMappingURL=ConfabMeetJS.js.map