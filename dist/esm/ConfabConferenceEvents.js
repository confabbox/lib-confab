 ...
 */
export var ConfabConferenceEvents;
(function (ConfabConferenceEvents) {
    /**
     * Event indicates that the current conference audio input switched between audio
     * input states,i.e. with or without audio input.
     */
    ConfabConferenceEvents["AUDIO_INPUT_STATE_CHANGE"] = "conference.audio_input_state_changed";
    /**
     ...
     */
    ConfabConferenceEvents["AUDIO_UNMUTE_PERMISSIONS_CHANGED"] = "conference.audio_unmute_permissions_changed";
    /**
     * Indicates that authentication status changed.
     */
    ConfabConferenceEvents["AUTH_STATUS_CHANGED"] = "conference.auth_status_changed";
    /**
     * Fired just before the statistics module is disposed and it's the last chance
     * to submit some logs to the statistics service (ex. CallStats if enabled),
     * before it's disconnected.
     */
    ConfabConferenceEvents["BEFORE_STATISTICS_DISPOSED"] = "conference.beforeStatisticsDisposed";
    /**
     * Indicates that an error occurred.
     */
    ConfabConferenceEvents["CONFERENCE_ERROR"] = "conference.error";
    /**
     * Indicates that conference failed.
     */
    ConfabConferenceEvents["CONFERENCE_FAILED"] = "conference.failed";
    /**
     * Indicates that conference is in progress of joining.
     */
    ConfabConferenceEvents["CONFERENCE_JOIN_IN_PROGRESS"] = "conference.join_in_progress";
    /**
     * Indicates that conference has been joined. The event does NOT provide any
     * parameters to its listeners.
     */
    ConfabConferenceEvents["CONFERENCE_JOINED"] = "conference.joined";
    /**
     * Indicates that conference has been left.
     */
    ConfabConferenceEvents["CONFERENCE_LEFT"] = "conference.left";
    /**
     * Indicates that the conference unique identifier has been set.
     */
    ConfabConferenceEvents["CONFERENCE_UNIQUE_ID_SET"] = "conference.unique_id_set";
    /**
     * Indicates that the connection to the conference has been established
     * XXX This is currently fired when the *ICE* connection enters 'connected'
     * state for the first time.
     */
    ConfabConferenceEvents["CONNECTION_ESTABLISHED"] = "conference.connectionEstablished";
    /**
     * Indicates that the connection to the conference has been interrupted for some
     * reason.
     * XXX This is currently fired when the *ICE* connection is interrupted.
     */
    ConfabConferenceEvents["CONNECTION_INTERRUPTED"] = "conference.connectionInterrupted";
    /**
     * Indicates that the connection to the conference has been restored.
     * XXX This is currently fired when the *ICE* connection is restored.
     */
    ConfabConferenceEvents["CONNECTION_RESTORED"] = "conference.connectionRestored";
    /**
     * A connection to the video bridge's data channel has been established.
     */
    ConfabConferenceEvents["DATA_CHANNEL_OPENED"] = "conference.dataChannelOpened";
    /**
     * A user has changed it display name
     */
    ConfabConferenceEvents["DISPLAY_NAME_CHANGED"] = "conference.displayNameChanged";
    /**
     * The dominant speaker was changed.
     */
    ConfabConferenceEvents["DOMINANT_SPEAKER_CHANGED"] = "conference.dominantSpeaker";
    /**
     * UTC conference timestamp when first participant joined.
     */
    ConfabConferenceEvents["CONFERENCE_CREATED_TIMESTAMP"] = "conference.createdTimestamp";
    /**
     * Indicates that DTMF support changed.
     */
    ConfabConferenceEvents["DTMF_SUPPORT_CHANGED"] = "conference.dtmfSupportChanged";
    /**
     * Indicates that a message from another participant is received on data
     * channel.
     */
    ConfabConferenceEvents["ENDPOINT_MESSAGE_RECEIVED"] = "conference.endpoint_message_received";
    /**
     * Indicates that a message for the remote endpoint statistics has been received on the bridge channel.
     */
    ConfabConferenceEvents["ENDPOINT_STATS_RECEIVED"] = "conference.endpoint_stats_received";
    /**
     ...
     * @type {string}
     */
    ConfabConferenceEvents["JVB121_STATUS"] = "conference.jvb121Status";
    /**
     * You are kicked from the conference.
     * @param {ConfabParticipant} the participant that initiated the kick.
     */
    ConfabConferenceEvents["KICKED"] = "conference.kicked";
    /**
     * Participant was kicked from the conference.
     * @param {ConfabParticipant} the participant that initiated the kick.
     * @param {ConfabParticipant} the participant that was kicked.
     */
    ConfabConferenceEvents["PARTICIPANT_KICKED"] = "conference.participant_kicked";
    /**
     ...
     */
    ConfabConferenceEvents["LAST_N_ENDPOINTS_CHANGED"] = "conference.lastNEndpointsChanged";
    /**
     ...
     * sources
     */
    ConfabConferenceEvents["FORWARDED_SOURCES_CHANGED"] = "conference.forwardedSourcesChanged";
    /**
     * Indicates that the room has been locked or unlocked.
     */
    ConfabConferenceEvents["LOCK_STATE_CHANGED"] = "conference.lock_state_changed";
    /**
     * Indicates that the region of the media server (confab-videobridge) that we
     * are connected to changed (or was initially set).
     * @type {string} the region.
     */
    ConfabConferenceEvents["SERVER_REGION_CHANGED"] = "conference.server_region_changed";
    /**
     * An event(library-private) fired when a new media session is added to the conference.
     * @type {string}
     * @private
     */
    ConfabConferenceEvents["_MEDIA_SESSION_STARTED"] = "conference.media_session.started";
    /**
     * An event(library-private) fired when the conference switches the currently active media session.
     * @type {string}
     * @private
     */
    ConfabConferenceEvents["_MEDIA_SESSION_ACTIVE_CHANGED"] = "conference.media_session.active_changed";
    /**
     ...
     */
    ConfabConferenceEvents["MEMBERS_ONLY_CHANGED"] = "conference.membersOnlyChanged";
    /**
     * New text message was received.
     */
    ConfabConferenceEvents["MESSAGE_RECEIVED"] = "conference.messageReceived";
    /**
     * Event indicates that the current selected input device has no signal
     */
    ConfabConferenceEvents["NO_AUDIO_INPUT"] = "conference.no_audio_input";
    /**
     * Event indicates that the current microphone used by the conference is noisy.
     */
    ConfabConferenceEvents["NOISY_MIC"] = "conference.noisy_mic";
    /**
     * Indicates that a message from the local user or from the Prosody backend
     * was received on the data channel.
     */
    ConfabConferenceEvents["NON_PARTICIPANT_MESSAGE_RECEIVED"] = "conference.non_participant_message_received";
    /**
     * New private text message was received.
     */
    ConfabConferenceEvents["PRIVATE_MESSAGE_RECEIVED"] = "conference.privateMessageReceived";
    /**
     ...
     */
    ConfabConferenceEvents["PARTICIPANT_CONN_STATUS_CHANGED"] = "conference.participant_conn_status_changed";
    /**
     * Indicates that the features of the participant has been changed.
     * TODO: there is a spelling mistake in this event name and associated constants
     */
    ConfabConferenceEvents["PARTCIPANT_FEATURES_CHANGED"] = "conference.partcipant_features_changed";
    /**
     * Indicates that a the value of a specific property of a specific participant
     * has changed.
     */
    ConfabConferenceEvents["PARTICIPANT_PROPERTY_CHANGED"] = "conference.participant_property_changed";
    /**
     * Indicates that the conference has switched between JVB and P2P connections.
     * The first argument of this event is a <tt>boolean</tt> which when set to
     * <tt>true</tt> means that the conference is running on the P2P connection.
     */
    ConfabConferenceEvents["P2P_STATUS"] = "conference.p2pStatus";
    /**
     * Indicates that phone number changed.
     */
    ConfabConferenceEvents["PHONE_NUMBER_CHANGED"] = "conference.phoneNumberChanged";
    /**
     * The conference properties changed.
     * @type {string}
     */
    ConfabConferenceEvents["PROPERTIES_CHANGED"] = "conference.propertiesChanged";
    /**
     * Indicates that recording state changed.
     */
    ConfabConferenceEvents["RECORDER_STATE_CHANGED"] = "conference.recorderStateChanged";
    /**
     * Indicates that video SIP GW state changed.
     * @param {VideoSIPGWConstants} status.
     */
    ConfabConferenceEvents["VIDEO_SIP_GW_AVAILABILITY_CHANGED"] = "conference.videoSIPGWAvailabilityChanged";
    /**
     ...
     * }.
     */
    ConfabConferenceEvents["VIDEO_SIP_GW_SESSION_STATE_CHANGED"] = "conference.videoSIPGWSessionStateChanged";
    /**
     * Indicates that start muted settings changed.
     */
    ConfabConferenceEvents["START_MUTED_POLICY_CHANGED"] = "conference.start_muted_policy_changed";
    /**
     * Indicates that the local user has started muted.
     */
    ConfabConferenceEvents["STARTED_MUTED"] = "conference.started_muted";
    /**
     * Indicates that subject of the conference has changed.
     */
    ConfabConferenceEvents["SUBJECT_CHANGED"] = "conference.subjectChanged";
    /**
     * Indicates that DTMF support changed.
     */
    ConfabConferenceEvents["SUSPEND_DETECTED"] = "conference.suspendDetected";
    /**
     * Event indicates that local user is talking while he muted himself
     */
    ConfabConferenceEvents["TALK_WHILE_MUTED"] = "conference.talk_while_muted";
    /**
     ...
     */
    ConfabConferenceEvents["TRACK_ADDED"] = "conference.trackAdded";
    /**
     * Audio levels of a media track ( attached to the conference) was changed.
     */
    ConfabConferenceEvents["TRACK_AUDIO_LEVEL_CHANGED"] = "conference.audioLevelsChanged";
    /**
     * A media track ( attached to the conference) mute status was changed.
     * @param {ConfabParticipant|null} the participant that initiated the mute
     * if it is a remote mute.
     */
    ConfabConferenceEvents["TRACK_MUTE_CHANGED"] = "conference.trackMuteChanged";
    /**
     ...
     */
    ConfabConferenceEvents["TRACK_REMOVED"] = "conference.trackRemoved";
    /**
     * The source-add for unmuting of a media track was rejected by Jicofo.
     *
     */
    ConfabConferenceEvents["TRACK_UNMUTE_REJECTED"] = "conference.trackUnmuteRejected";
    /**
     ...
     */
    ConfabConferenceEvents["TRANSCRIPTION_STATUS_CHANGED"] = "conference.transcriptionStatusChanged";
    /**
     * A new user joined the conference.
     */
    ConfabConferenceEvents["USER_JOINED"] = "conference.userJoined";
    /**
     * A user has left the conference.
     */
    ConfabConferenceEvents["USER_LEFT"] = "conference.userLeft";
    /**
     * User role changed.
     */
    ConfabConferenceEvents["USER_ROLE_CHANGED"] = "conference.roleChanged";
    /**
     * User status changed.
     */
    ConfabConferenceEvents["USER_STATUS_CHANGED"] = "conference.statusChanged";
    /**
     ...
     */
    ConfabConferenceEvents["VIDEO_UNMUTE_PERMISSIONS_CHANGED"] = "conference.video_unmute_permissions_changed";
    /**
     * Event indicates that the bot participant type changed.
     */
    ConfabConferenceEvents["BOT_TYPE_CHANGED"] = "conference.bot_type_changed";
    /**
     * A new user joined the lobby room.
     */
    ConfabConferenceEvents["LOBBY_USER_JOINED"] = "conference.lobby.userJoined";
    /**
     * A user from the lobby room has been update.
     */
    ConfabConferenceEvents["LOBBY_USER_UPDATED"] = "conference.lobby.userUpdated";
    /**
     * A user left the lobby room.
     */
    ConfabConferenceEvents["LOBBY_USER_LEFT"] = "conference.lobby.userLeft";
    /**
     ...
     * }.
     */
    ConfabConferenceEvents["AV_MODERATION_APPROVED"] = "conference.av_moderation.approved";
    /**
     ...
     * }.
     */
    ConfabConferenceEvents["AV_MODERATION_REJECTED"] = "conference.av_moderation.rejected";
    /**
     ...
     * }.
     */
    ConfabConferenceEvents["AV_MODERATION_CHANGED"] = "conference.av_moderation.changed";
    /**
     ...
     * }.
     */
    ConfabConferenceEvents["AV_MODERATION_PARTICIPANT_APPROVED"] = "conference.av_moderation.participant.approved";
    /**
     ...
     * }.
     */
    ConfabConferenceEvents["AV_MODERATION_PARTICIPANT_REJECTED"] = "conference.av_moderation.participant.rejected";
    /**
     * A new face landmark object is added for a participant
     */
    ConfabConferenceEvents["FACE_LANDMARK_ADDED"] = "conference.face_landmark.added";
    /**
     * Event fired when a participant is requested to join a given (breakout) room.
     */
    ConfabConferenceEvents["BREAKOUT_ROOMS_MOVE_TO_ROOM"] = "conference.breakout-rooms.move-to-room";
    /**
     * Event fired when the breakout rooms data was updated.
     */
    ConfabConferenceEvents["BREAKOUT_ROOMS_UPDATED"] = "conference.breakout-rooms.updated";
})(ConfabConferenceEvents || (ConfabConferenceEvents = {}));
;
...
//# sourceMappingURL=ConfabConferenceEvents.js.map