...
export default class ConfabParticipant {
    ...
    hasAnyVideoTrackWebRTCMuted() {
        return (this.getTracks().some(confabTrack => confabTrack.getType() === MediaType.VIDEO
    ...
    setProperty(name, value) {
        ...
        if (value !== oldValue) {
            ...
            this._conference.eventEmitter.emit(ConfabConferenceEvents.PARTICIPANT_PROPERTY_CHANGED, this, name, oldValue, value);
        }
    }
    /**
...
//# sourceMappingURL=ConfabParticipant.js.map