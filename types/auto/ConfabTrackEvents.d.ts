export declare enum ConfabTrackEvents {
    /**
...
export declare const LOCAL_TRACK_STOPPED = ConfabTrackEvents.LOCAL_TRACK_STOPPED;
export declare const TRACK_AUDIO_LEVEL_CHANGED = ConfabTrackEvents.TRACK_AUDIO_LEVEL_CHANGED;
export declare const TRACK_AUDIO_OUTPUT_CHANGED = ConfabTrackEvents.TRACK_AUDIO_OUTPUT_CHANGED;
export declare const TRACK_MUTE_CHANGED = ConfabTrackEvents.TRACK_MUTE_CHANGED;
export declare const TRACK_VIDEOTYPE_CHANGED = ConfabTrackEvents.TRACK_VIDEOTYPE_CHANGED;
export declare const NO_DATA_FROM_SOURCE = ConfabTrackEvents.NO_DATA_FROM_SOURCE;
export declare const NO_AUDIO_INPUT = ConfabTrackEvents.NO_AUDIO_INPUT;
export declare const TRACK_STREAMING_STATUS_CHANGED = ConfabTrackEvents.TRACK_STREAMING_STATUS_CHANGED;
