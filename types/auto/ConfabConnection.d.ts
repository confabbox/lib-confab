 ...
 * @constructor
 */
export default function ConfabConnection(appID: any, token: any, options: any): void;
export default class ConfabConnection {
     ...
     */
    initConfabConference(name: any, options: any): ConfabConference;
    /**
     * Subscribes the passed listener to the event.
     * @param event {ConfabConnectionEvents} the connection event.
     * @param listener {Function} the function that will receive the event
     */
    addEventListener(event: typeof ConfabConnectionEvents, listener: Function): void;
    /**
     * Unsubscribes the passed handler.
     * @param event {ConfabConnectionEvents} the connection event.
     * @param listener {Function} the function that will receive the event
     */
    removeEventListener(event: typeof ConfabConnectionEvents, listener: Function): void;
    /**
