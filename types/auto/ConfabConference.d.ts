 ...
 *       and so on...
 */
declare function ConfabConference(options: any): void;
declare class ConfabConference {
    /**
     * Creates a ConfabConference object with the given name and properties.
     * Note: this constructor is not a part of the public API (objects should be
     * created using ConfabConnection.createConference).
    ...
    options: any;
    eventManager: ConfabConferenceEventManager;
    participants: {};
    /**
    ...
    constructor: typeof ConfabConference;
    /**
     ...
     */
    getParticipantById(id: any): ConfabParticipant;
    /**
...
declare namespace ConfabConference {
    /**
...
export default ConfabConference;
