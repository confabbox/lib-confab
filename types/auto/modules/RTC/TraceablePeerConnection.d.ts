...
export default class TraceablePeerConnection {
     ...
     */
    remoteTracks: Map<string, Map<MediaType, Set<ConfabRemoteTrack>>>;
    /**
    ...
    */
     ...
     */
    getRemoteTracks(endpointId?: string, mediaType?: MediaType): Array<ConfabRemoteTrack>;
    /**
     ...
     * @returns {void}
     */
    _removeRemoteTrack(toBeRemoved: ConfabRemoteTrack): void;
    /**
