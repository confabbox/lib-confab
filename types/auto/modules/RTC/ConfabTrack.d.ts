...
export default class ConfabTrack extends EventEmitter {
    ...
    addEventListener: (eventName: string | symbol, listener: (...args: any[]) => void) => ConfabTrack;
    removeEventListener: (eventName: string | symbol, listener: (...args: any[]) => void) => ConfabTrack;
    /**
