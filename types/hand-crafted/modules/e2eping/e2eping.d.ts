...
export default class E2ePing {
  constructor( conference: ConfabConference, options: E2ePingOptions, sendMessage: ( response: E2eResponse, participant: string ) => void ); // TODO: jsdoc arguments are in the wrong order
  dataChannelOpened: () => void;
  messageReceived: ( participant: unknown, payload: unknown ) => void; // TODO:
  participantJoined: ( id: string, participant: ConfabParticipant ) => void;
