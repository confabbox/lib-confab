...
export default class JingleSessionPC extends JingleSession {
  ...
  acceptOffer: ( jingleOffer: JQuery, success: ( params: unknown ) => unknown, failure: ( params: unknown ) => unknown, localTracks?: ConfabLocalTrack[] ) => void; // TODO:
  invite: ( localTracks?: ConfabLocalTrack[] ) => void;
  sendSessionInitiate: ( offerSdp: string ) => void;
  setAnswer: ( jingleAnswer: unknown ) => void; // TODO:
  setOfferAnswerCycle: ( jingleOfferAnswerIq: JQuery, success: ( params: unknown ) => unknown, failure: ( params: unknown ) => unknown, localTracks?: ConfabLocalTrack[] ) => void; // TODO:
  ...
  removeRemoteStreamsOnLeave: ( id: string ) => Promise<ConfabRemoteTrack>;
  replaceTrack: ( oldTrack: ConfabLocalTrack | null, newTrack: ConfabLocalTrack | null ) => Promise<unknown>; // TODO:
  addTrackAsUnmute: ( track: ConfabLocalTrack ) => Promise<unknown>; // TODO:
  removeTrackAsMute: ( track: ConfabLocalTrack ) => Promise<unknown>; // TODO:
