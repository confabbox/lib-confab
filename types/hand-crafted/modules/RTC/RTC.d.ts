...
export default class RTC extends Listenable {
  destroy: () => void;
  static createLocalTracks: ( tracksInfo: unknown[] ) => ConfabLocalTrack[]; // TODO:
  ...
  getLocalAudioTrack: () => ConfabLocalTrack | undefined;
  getLocalEndpointId: () => string;
  getLocalTracks: ( mediaType: MediaType ) => ConfabLocalTrack[];
  getRemoteTracks: ( mediaType: MediaType ) => ConfabRemoteTrack[];
