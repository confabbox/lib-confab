...
MockConference.prototype = Object.create(ConfabConference.prototype);
MockConference.prototype.constructor = ConfabConference;

/**
 * Mock object to be used in place of a real ConfabParticipant.
 *
 * @constructor
 ...
 * @returns {void}
 */
function MockConfabParticipant(id, name) {
    this._jid = id;
    this._displayName = name;
}
MockConfabParticipant.prototype = Object.create(ConfabParticipant.prototype);
MockConfabParticipant.prototype.constructor = ConfabParticipant;
...
describe('SpeakerStatsCollector', () => {
    ...
    beforeEach(() => {
        ...
        mockConference.eventEmitter.emit(
            ...
            mockRemoteUser.id,
            new MockConfabParticipant(mockRemoteUser.id, mockRemoteUser.name)
        );
    });
